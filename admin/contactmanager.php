                        ...
                        <table class="table table-borderless datatable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-1 text-center">Vấn đề</th>
                                    <th class="col-2 text-center">Tin nhắn</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <th class="text-center"><?php echo $row["phone"] ?></th>
                                            <th class="text-center"><?php echo $row["subject"] ?></th>
                                            <th class="text-center"><?php echo $row["message"] ?></th>
                                            <td class="text-center">
                                                <a onclick="return confirm(' Bạn có chắc chắn muốn xoá?')" href="deletecontact.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm"><i class="bi bi-trash"></i></a>
                                            </td>
                                        </tr>
                                <?php
                                    }
